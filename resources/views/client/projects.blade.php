...
<section id="approved-projects">
    <div class="tabs">
        <button class="tablink active" onclick="openTab(event, 'all')">all projects</button>
            ...
            <tbody>
                @foreach($projects as $project)
                    <tr>
                        ...
                        @endif
                        <td>
                            <a href="{{route('client.projectDetails', $project->id)}}" class="view-btn">view Details</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
            ...
            <tbody>
                @foreach($completed as $project)
                    <tr>
                        ...
                        <td>
                            <a href="{{route('client.projectDetails', $project->id)}}" class="view-btn">view Details</a>
                            <a href="{{route('client.bill',$project->id)}}" class="view-btn">view Bill</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
