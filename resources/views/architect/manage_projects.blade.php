            ...
            <tbody>
                @foreach($waiting as $project)
                    <tr>
                        ...
                        @endif
                        <td>
                           <a href="{{route('architect.projectDetails',$project->id)}}" class="view-btn">view Details</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
            ...
            <tbody>
                @foreach($onprogress as $project)
                    <tr>
                        ...
                        <td>
                        <a href="{{route('architect.projectDetails',$project->id)}}" class="view-btn">view Details</a>
                        <form action="{{route('architect.updateProject', $project->id)}}" method="post" style="background-color:transparent; display:inline-block">
                                @csrf
                                @method('PUT') 
