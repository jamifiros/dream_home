        ...
        @endif            
           ...
           <div class="action-btns">
              ...
              <div>
                   ...
                   <a href="{{route('admin.deleteStaff',$staff->id)}}" class="delete-btn"onclick="return confirm('Are you sure?')">Delete</a>
                   </td>
              </div>
            </div>
        </div>
...
<div id="editmodal" class="modal">
    <div class="modal-content">
        ...
        <h2>Edit Profile</h2>
        <!-- Edit Profile Form -->
        <form id="staffForm" method="POST" action="{{route('admin.updateStaff', $staff->id)}}" enctype="multipart/form-data">
            @csrf
        ...
        <br>
            ...
            <input type="radio" name="gender" id="gender" value="male" {{ $staff->gender == 'male' ? 'checked' : '' }} required> Male
...
<div id="pswmodal" class="modal">
    <div class="modal-content">
        ...
        <form id="staffForm" method="POST" action="{{route('admin.changePswd', $staff->id)}}" enctype="multipart/form-data">
        @csrf
        @method('PUT') <!-- Method for updating -->
